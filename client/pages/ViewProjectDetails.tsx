    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          setVisible(true);
          observer.unobserve(entry.target); // ek baar hi aaye
        }
      },
      { threshold: 0.25 }
    );
...
const bhk2Ref = useRef(null);
const [bhk2Visible, setBhk2Visible] = useState(false);
...
useEffect(() => {
  ...
  if (bhk2Ref.current) observer.observe(bhk2Ref.current);
      ...
      <section className="bg-[#FFFEFD] py-0 md:py-24 -mt-64 md:mt-0">
        <div className="max-w-8xl mx-auto px-4 md:px-6">
            ...
            <div className="text-[#5F5F5F] font-montserrat -mt-4 text-[18px] font-medium leading-relaxed space-y-6 ml-4 md:-ml-60 mr-4 md:mr-24">
                ...
                is a luxurious yet affordable residential apartment project by{" "}
                <span className="font-semibold text-[#2B2B2B]">
                    Niketan Builders, located in Raj Nagar, Hubballi.
                </span>
                Strategically positioned near educational institutions, hospitals,
                recreational clubs, retail outlets, and entertainment hubs,
                it offers excellent urban connectivity.
                </p>

                <p>
                The project features Vastu-compliant{" "}
                <span className="font-semibold text-[#2B2B2B]">
                    2 BHK
                </span>{" "}
                and
                <span className="font-semibold text-[#2B2B2B]"> 3 BHK </span>
                apartments, meticulously crafted to provide generous space,
                comfort, and contemporary living. Designed amidst greenery,
                Niketan Luxuria offers state-of-the-art amenities in a calm
                and tranquil residential neighborhood — making it ideal for
                modern families seeking quality living.
                </p>
            </div>
            </div>
        ...
        <div
        ref={photoRef}
        className={`max-w-8xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-6
        ...
        <div
            ...
            <section
            ref={bhk2Ref}
            className={`w-full px-4 sm:px-6 md:px-12 py-2 md:py-20 bg-white
            transition-all duration-1000 ease-out
            ${bhk2Visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20"}`}
            >
            <div className="max-w-8xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-start">
                ...
                ">
                    Smartly designed homes offering a perfect balance of space,
                    comfort, and value. Ideal for families looking for efficient
                    living with long-term benefits.
                </p>
                ...
                <ul className="space-y-4 text-[#000000] font-montserrat font-regular text-[16px] md:text-[18px] ml-4 md:ml-0 mr-4 md:mr-0">
                    ...
                    <span>Spacious & efficient layouts</span>
                    </li>
                    ...
                    <li className="flex items-start gap-3">
                    <ArrowRight className="w-6 h-6 md:w-7 md:h-6 mt-1 text-[#CE9162]" />
                    <span>Ample natural light & ventilation</span>
                    </li>
                </ul>
            ...
            <section
            ref={sectionRef}
            className={`w-full px-4 sm:px-6 md:px-12 py-12 md:py-8 bg-white
            transition-all duration-1000 ease-out
            ...
            <div className="max-w-8xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-start">
                ...
                <p
                    ...
                    "
                >
                    Well-designed 3 BHK homes created for comfortable
                    family living with a touch of premium appeal.
                    Thoughtful planning and quality finishes ensure
                ...
                <ul className="space-y-4 text-[#000000] font-montserrat font-regular text-[16px] md:text-[18px]">
                    <li className="flex items-start gap-3">
                    <ArrowRight className="w-6 h-6 md:w-7 md:h-6 mt-1 text-[#CE9162]" />
                    <span>Spacious family-friendly layouts</span>
                    </li>
                    ...
                    <li className="flex items-start gap-3">
                    <ArrowRight className="w-6 h-6 md:w-7 md:h-6 mt-1 text-[#CE9162]" />
                    <span>Modern planning & amenities</span>
                    </li>
            ...
            <div className="max-w-8xl mx-auto px-4 md:px-0 md:ml-12 md:mr-12">
                ...
                <div>
                    ...
                    <h3 className="text-[20px] md:text-[24px] font-montserrat font-semibold text-[#2B2B2B] mb-4">
                    Smart Layouts for <br /> Comfortable Living
                    </h3>

                    <p className="text-[15px] md:text-[16px] ml-4 md:ml-0 mr-4 md:mr-0 font-montserrat font-regular text-[#000000] leading-relaxed">
                    Well-planned homes with balanced <br className="hidden md:block" />
                    spaces, natural light, and privacy for <br className="hidden md:block" />
                ...
                <div>
                    ...
                    <h3 className="text-[20px] md:text-[24px] font-montserrat font-semibold text-[#2B2B2B] mb-4">
                    Private & Community <br /> Spaces Above the City
                    </h3>

                    <p className="text-[15px] md:text-[16px] ml-4 md:ml-0 mr-4 md:mr-0 font-montserrat font-regular text-[#000000] leading-relaxed">
                    Landscaped private terraces and shared areas <br className="hidden md:block" />
                    designed for relaxation, gatherings, and <br className="hidden md:block" />
                    leisure.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <h3 className="text-[20px] md:text-[24px] font-montserrat font-semibold text-[#2B2B2B] mb-4">
                    Organized Access with <br /> Ample Parking
                    </h3>

                    <p className="text-[15px] md:text-[16px] ml-4 md:ml-0 mr-4 md:mr-0 font-montserrat font-regular text-[#000000] leading-relaxed">
                    Efficiently planned driveways and parking <br className="hidden md:block" />
                    bays ensure smooth movement <br className="hidden md:block" />
            ...
            <div className="max-w-8xl mx-auto px-4 ml-0 md:ml-20">
                ...
                <div>
                    ...
                    ml-6 md:-ml-4
                    ">
                    <li>Well-connected developing location</li>
                    <li>Easy access to main city roads</li>
                    <li>Convenient everyday connectivity</li>
                    <li>Peaceful residential surroundings</li>
                    <li>Future-ready investment location</li>
                    <li>Strong potential for future growth and appreciation</li>
                    </ul>
                </div>
                </div>
            </div>
            ...
            <div className="max-w-8xl mx-auto px-4 ml-4 md:ml-20 mr-4 md:mr-20 -mt-8 md:mt-0">
            ...
            {/* CTA Section */}
            <section className="relative py-20 sm:py-40 px-4 sm:px-6 lg:px-8 overflow-hidden mt-8 md:mt-0 cta-bg">
